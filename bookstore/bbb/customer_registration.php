	...
	<body class="d-flex flex-column min-vh-100">
		...
		<div class="container-fluid">
			<div class="standard-container bg-white shadow">
				...
				<form class="row g-3" action = "generate_customer.php" method = "POST">
					<div class="col-md-6">
					...
					<div class="col-md-3">
						...
						<input required type="text" class="form-control" id="inputExpDate" placeholder="MM/YY" name = "exp_date">
					</div>
					<div class="col-6 text-end">
						<a class="btn btn-md btn-warning" href="register_message.php">Don't Register</a>
					</div>
